    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE WHEN UPPER(TRIM(cst_marital_status)) = 'S' THEN 'Single'
                ...
                ELSE 'n/a'
            END cst_marital_status,                               --Normalize matrial status values to readable format
        ...
        WHERE flag_last = 1;                                    --select the most recent recor per customer (removing duplicates)
